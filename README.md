...
[![Docker Pulls](https://img.shields.io/docker/pulls/zsozso22/terraform-azure-cli.svg)](https://hub.docker.com/r/zsozso22/terraform-azure-cli/)

<p align="center">
  <a href="https://azure.microsoft.com"><img width="200" src="https://github.com/zsozso22/terraform-azure-cli/raw/master/resources/azure-logo.png"></a>
  <a href="https://www.terraform.io/"><img width="200" src="https://github.com/zsozso22/terraform-azure-cli/raw/master/resources/terraform-logo.png"></a>
</p>

# Terraform and Azure CLI Docker image

## 📦 Supported tags and respective Dockerfile links
Available image tags can be found on the Docker Hub registry: [zsozso22/terraform-azure-cli](https://hub.docker.com/r/zsozso22/terraform-azure-cli/tags)
...
* `zsozso22/terraform-azure-cli:latest` - build from master
...
* `zsozso22/terraform-azure-cli:release-S.T_terraform-UU.VV.WW_azcli-XX.YY.ZZ` - build from releases
...
```bash
docker container run -it --rm --mount type=bind,source="$(pwd)",target=/workspace zsozso22/terraform-azure-cli:latest
```
...
* Build and tag the image `zsozso22/terraform-azure-cli:dev`;
